			...
			<div class="content">
				...
				<div id="user_timeline">
					<div id="user_details">
						...
						"	
							...
							<div id='user_mention'>	
								<p><strong>Name:</strong> $user_username</p>
								<p><strong>Home Town:</strong> $user_hometown</p>
								<p><strong>Member since:</strong> $user_registerdate</p>
								<p><strong>Last Login:</strong> $user_lastlogin</p>
				...
				<div id="content_timeline">
					<form action="home.php?id=<?php echo $user_id;?>" method="post" id="f">
						...
						<input type="text" name="title" placeholder="Write a title" size="70"/><br/>
